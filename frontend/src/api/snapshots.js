...
export const startSnapshot = (dish_slug, level, lang) =>
  api.post("/recipe-snapshot", { dish_slug, level, lang }).then((r) => r.data);

export const readSnapshot = (snapshotId, dish_slug, level, lang) =>
  api.get(`/recipe-snapshot/${snapshotId}`, { params: { dish_slug, level, lang } }).then((r) => r.data);
