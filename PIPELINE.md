...
- Offline caching itself needs a real-browser check (see SW note above)
- Broader error-state audit beyond Home/RecipePage (GroceryPage, ProgressPage, GlossaryPage fetches still lack explicit retry UI)
